class CustomFieldsRegisterController < Devise::RegistrationsController
  ...
  private
    ...
    def sign_up_params
      ...
      params.require(:user).permit(:username, :email, :password,
                                   ...
                                   :redeemable_code,:surname,:name,:gender,:native_language,:date_of_birth,:residence,
                                   :education,:identify_yourself)
    end

class PollsController < ApplicationController
  ...
  def index
    @remote_translations = detect_remote_translations(@polls)
  ...
  def show
    ...
    @remote_translations = detect_remote_translations([@poll], @questions, @poll_questions_answers, @comment_tree.comments)
  end
